    ...
    <main class="ml-[280px] transition duration-300 ease-in-out">
        ...
        <div class="bg-white mx-10">
          ...
          <div class="flex justify-between items-center mx-8">
            <p class="font-bold">Asset Depreciation >> Fiscal >></p>
            ...
            <table class="table-auto text-sm w-full">
                <thead class="text-center">
                    <tr class="border-2">
                        ...
                        <th class="border-2">Depreciation Value</th>
                    </tr>
                </thead>
                <tbody class="text-center">
                    ...
                    <tr>
                        ...
                        <td class="border-2">{{$item->costCentre}}</td>
          ...
          <div class="flex justify-between py-10 px-6">
            <button type="button" class="flex text-white justify-center items-center w-fit bg-[#79C4FB] px-2 py-1 rounded">
              <p class="font-bold">Cetak</p>
            </button>
