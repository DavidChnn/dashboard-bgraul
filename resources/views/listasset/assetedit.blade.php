  ...
  <body class="bg-[#F5FAFF]">
    ...
    <main class="ml-[280px] transition duration-300 ease-in-out">
        ...
        <div class="bg-white mx-10 mb-10 pb-10">
          ...
          <form action="{{ url('/listasset/assetedit/'.$data->id)}}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="grid grid-cols-2 overflow-y-auto gap-x-10 gap-y-5 px-6">
              <div class="flex justify-between">
                  ...
                  <div class="bg-[#ECE9E9] w-64 px-4 rounded">
                    <input required type="type" class="bg-[#ECE9E9] w-full outline-none" value="{{$data->assetCodeAccounting}}" placeholder="{{$data->assetCodeAccounting}}" name="assetCodeAccounting" id="assetCodeAccounting">
                  </div>
              </div>
              <div class="flex justify-between">
                <p>Acqusition CIP</p>
              ...
              <div class="flex justify-between">
                ...
                <div class="bg-[#ECE9E9] w-64 px-4 rounded">
                    <input required type="type" class="bg-[#ECE9E9] w-full outline-none" value="{{$data->inventoryNumber}}" placeholder="{{$data->inventoryNumber}}" name="inventoryNumber" id="inventoryNumber">
                </div>
              </div>
              <div class="flex justify-between">
                <p>Department</p>
